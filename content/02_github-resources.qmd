...
To add a license to your repository, navigate to the base level of your repository (so not in a subdirectory) and add a file called LICENSE. Under the file name, click Choose a license template, select\
**Apache-2.0 license**.
...
![Repositories in the CB-Genetics Team](CB-Genetics%20Team%20Repositories.png){fig-align="center"}
...
![](nwfsc-cb-genetics%20topic%20results.png)
