...
-   Work and commit in the main branch of a repo (see species cases for branching and forking below)

-   **Commits**

    -   Perform commits daily at minimum when working on analysis

    -   Make sure to push to origin daily as well!
...
Edit here- what to include in repos

Assign to team CB-Genetics (can choose permissions)
